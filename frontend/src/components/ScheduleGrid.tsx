        ...
        <GlassCard className="p-6 overflow-x-auto overflow-y-hidden">
            <div className="min-w-max">
                ...
                <div className="flex gap-2 mb-4">
                    ...
                    {/* Columns */}
                    {periods.map((period) => (
                        <div key={period.id} className="w-[120px] shrink-0 flex flex-col items-center">
                    ...
                    {DAYS.map((day) => {
                        ...
                        return (
                            <div key={day} className="flex gap-2 items-stretch h-20">
                                ...
                                {/* Period Cells */}
                                {periods.map((period) => {
                                    const isBreakConfig = period.type === 'break';
                                    ...
                                    if (isBreakConfig && !slot) {
                                        // Static break column cells - just empty/transparent
                                        return (
                                            <div
                                                key={period.id}
                                                className="w-[120px] shrink-0 bg-surface-container-low/30 flex items-center justify-center opacity-20"
                                            />
                                        );
                                    }
                                    ...
                                    return (
                                        <div
                                            key={period.id}
                                            className="w-[120px] shrink-0 relative group"
